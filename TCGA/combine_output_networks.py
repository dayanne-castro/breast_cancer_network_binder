...
network1 = pd.read_csv('TCGA_BBSR1.1_ChromPrior_TfsPrior.tsv', sep = '\t')
network2 = pd.read_csv('TCGA_BBSR1.1_TrrustPrior_TfsPrior.tsv', sep = '\t')
...
network_final.to_csv('TCGA_BBSR1.1_combinedPriors_TfsPriors.tsv', sep = '\t', index = False)
